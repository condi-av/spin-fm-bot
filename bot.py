...
🟦 По кнопке ниже, покажу справочник по озёрам в радиусе 100км от пгт.Озёрный.
🎯 Или выбери нужную кнопку меню, и я пришлю тебе прогноз!
🔮 Помни, 100% прогнозов не бывает. Ехать или нет решаешь только ты. 🫵
"""
